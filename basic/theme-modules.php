	...
	function themify_default_layout($data=array()){
		...
		$output .=	'	</select>
					...
					<p>
						...
						<input type="checkbox" value="1" name="setting-auto_featured_image" '.checked($data['setting-auto_featured_image'], 1, false).'/> ' .
	...
	function themify_footer_logo($data=array()){
		...
		return '<div class="row">
					...
					<div class="uploader-fields">
						...
						<div class="pushlabel" style="display:block;">' . themify_get_uploader('setting-footer_logo_image_value', array('tomedia' => true)) . '</div>
					</div>
